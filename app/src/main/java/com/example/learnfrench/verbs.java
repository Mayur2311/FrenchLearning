...
public class verbs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer= MediaPlayer.create(this,R.raw.verbs);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), tenses.class);
                startActivity(intent);
            }
        });
        ...
        prevbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), nouns.class);
                startActivity(intent);
            }
        });
