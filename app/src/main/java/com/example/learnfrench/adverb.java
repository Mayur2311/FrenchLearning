...
public class adverb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer= MediaPlayer.create(this,R.raw.adverbs);
       ...
       int maxvolume= audioManager.getStreamMaxVolume(AudioManager.STREAM_MUSIC);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(adverb.this,"You have completed learning Intermediate Level", Toast.LENGTH_SHORT).show();
        ...
        prevbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), pronoun.class);
                startActivity(intent);
            }
        });
