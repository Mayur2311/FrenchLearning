...
//        btn_next.setVisibility(View.INVISIBLE);
        ...
        question1 = "On a ____ une nouvelle autoroute entre Orléans et Clermont-Ferrand.";
        optionA_que1 = "conduit";
        optionB_que1 = "dirigé";
        optionC_que1 = "confectionné";
        optionD_que1 = "construit";
        rightanswer1 = "construit";

        question2 = "Prête-moi tes CD pour ce soir; je te les rendrai ____.";
        optionA_que2 = "quelquefois";
        optionB_que2 = "bientôt";
        optionC_que2 = "jamais";
        optionD_que2 = "jadis";
        rightanswer2 = "bientôt";
        ...
        question4 = "Peut-être __ les prix augmenteront ce trimestre.";
        optionA_que4 = "qui";
        optionB_que4 = "que";
        optionC_que4 = "si";
        optionD_que4 = "pas";
