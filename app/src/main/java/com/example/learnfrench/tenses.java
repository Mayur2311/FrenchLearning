...
public class tenses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer= MediaPlayer.create(this,R.raw.perfecttense);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), adjective.class);
                startActivity(intent);
            }
        });
        ...
        prevbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), verbs.class);
                startActivity(intent);
            }
        });
    }
