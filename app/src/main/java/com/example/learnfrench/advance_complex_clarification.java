...
public class advance_complex_clarification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance_complex_clarification);

        nextbtn = findViewById(R.id.nextButton);
        prevbtn = findViewById(R.id.prevButton);
        homebtn = findViewById(R.id.homeButton);
        mediaPlayer= MediaPlayer.create(this,R.raw.complexclarification);
